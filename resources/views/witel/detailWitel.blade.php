        ...
        <div class="profile-details">
            <div class="profile-meta-grid">
                <div class="meta-item-inline">
                    ...
                    <span class="meta-value">{{ $profileData['total_account_managers'] ?? 0 }} orang</span>
                </div>

                <div class="meta-item-inline">
                    <i class="fas fa-building"></i>
                    <span class="meta-label">HOTDA</span>
                    <span class="meta-value">{{ $profileData['total_hotda'] ?? 0 }} HOTDA</span>
                </div>

                <div class="meta-item-inline">
                    <i class="fas fa-briefcase"></i>
                    <span class="meta-label">Corporate Customers</span>
                    <span class="meta-value">{{ $profileData['total_customers'] ?? 0 }} customers</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="revenue-cards-group">
        <div class="revenue-summary-card total-revenue">
            <div class="revenue-card-header">
                ...
                <div class="revenue-card-icon"><i class="fas fa-money-bill-wave"></i></div>
            </div>
        ...
        <div class="revenue-summary-card total-target">
            <div class="revenue-card-header">
                ...
                <div class="revenue-card-icon"><i class="fas fa-bullseye"></i></div>
            </div>
            <div class="revenue-card-value">
        ...
        <div class="revenue-summary-card achievement-rate">
            <div class="revenue-card-header">
                ...
                <div class="revenue-card-icon"><i class="fas fa-percentage"></i></div>
            </div>
            <div class="revenue-card-value">
                ...
                <div class="filters-wrapper">
                    ...
                    <div class="filters-row-all">
                        ...
                        <div class="view-mode-toggle">
                            ...
                            <button type="button"
                                class="view-mode-btn {{ ($filters['revenue_view_mode'] ?? '') == 'agregat_bulan' ? 'active' : '' }}"
                                data-mode="agregat_bulan">
                        ...
                        <div class="filter-dropdowns-row">
                            ...
                            <div class="filter-item">
                                <select id="roleFilter" class="selectpicker">
                                    <option value="all" {{ ($filters['role_filter'] ?? 'all') == 'all' ? 'selected' : '' }}>Semua (AM + HOTDA)</option>
                            ...
                            <div class="filter-item">
                                <select id="tipeRevenueFilter" class="selectpicker">
                                    <option value="all" {{ ($filters['tipe_revenue'] ?? 'all') == 'all' ? 'selected' : '' }}>Semua Tipe</option>
                            ...
                            <div class="filter-item">
                                <select id="revenueSourceFilter" class="selectpicker">
                                    <option value="all" {{ ($filters['revenue_source'] ?? 'all') == 'all' ? 'selected' : '' }}>Semua Source</option>
                            ...
                            <tbody>
                                @foreach($revenueData['revenues'] as $index => $revenue)
                                    <tr>
                                        ...
                                        <td><span class="month-badge">{{ $revenue->bulan_name ?? 'N/A' }}</span></td>
                                        ...
                                        <td>
                                            @php
                                                ...
                                                if ($achievement >= 100) $badgeClass = 'badge-success';
                                                elseif ($achievement >= 80) $badgeClass = 'badge-warning';
                                            @endphp
                    ...
                    <div class="chart-filters">
                        ...
                        <div class="filter-item">
                            <select id="chartDisplayMode" class="selectpicker">
                                <option value="combination" {{ ($filters['chart_display'] ?? 'combination') == 'combination' ? 'selected' : '' }}>Kombinasi</option>
